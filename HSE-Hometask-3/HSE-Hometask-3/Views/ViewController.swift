...
class ViewController: UIViewController, NewItemDelegate, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.delegate = self
        cell.configureSubstances(name: "fats", substance: cell.fats, amount: String(dish.fats))
        cell.configureSubstances(name: "protein",substance: cell.protein, amount: String(dish.protein))
        cell.configureSubstances(name: "carbs",substance: cell.carbs, amount: String(dish.carbs))
